#!/usr/bin/env sh
# Prints a percentage of the host's CPU count, for the units' --cpus limits:
# `cpu-share.sh 75`, `50`, `25`. Hardcoded limits
...
#
# Floored to a whole core and never below 1 (podman rejects --cpus=0). getconf
